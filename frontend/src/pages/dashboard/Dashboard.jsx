  ...
  return (
    ...
    >
      ...
      >
        <div>
          ...
          <div style={{ fontSize: 13, color: "#9ca3af" }}>
            Here's your store performance for today
          </div>
        </div>
        <button
      ...
      >
        ...
        <StatCard
          title="Orders Today"
          value={stats.todayOrders || stats.todaySales || 0}
        ...
        <StatCard
          ...
          color={lowStock.count > 0 ? "#ef4444" : "#1a9c3e"}
          bg={lowStock.count > 0 ? "#fef2f2" : "#f0fdf4"}
      ...
      >
            ...
            <ResponsiveContainer width="100%" height={220}>
              <LineChart data={weeklyRevenue}>
                ...
                <Line
                  ...
                  stroke="#1a9c3e"
                  strokeWidth={3}
                  dot={{ fill: "#1a9c3e", strokeWidth: 0, r: 4 }}
                  activeDot={{ r: 6 }}
                />
              </LineChart>
            </ResponsiveContainer>
        ...
        >
          ...
          <div
            style={{
              marginTop: 20,
              background: "rgba(26,156,62,0.15)",
              border: "1px solid rgba(26,156,62,0.3)",
              borderRadius: 12,
              padding: "10px 14px",
            }}
          >
            ...
            <div style={{ fontWeight: 800, fontSize: 20, color: "#1a9c3e" }}>
              ₹{Number(stats.todayRevenue || 0).toFixed(0)}
            </div>
            <div
              style={{
                fontSize: 11,
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {recentTx.slice(0, 6).map((tx, i) => (
                ...
                >
                  ...
                  <div
                    style={{ fontWeight: 800, fontSize: 14, color: "#1a9c3e" }}
                  >
                    ₹{tx.total || 0}
                  </div>
                </div>
            ...
            >
              <div>
                ...
                <div style={{ fontSize: 13, color: "#9ca3af", marginTop: 2 }}>
                  {lowStock.count} item{lowStock.count !== 1 ? "s" : ""} need
                  restocking
                </div>
              </div>
              <button
